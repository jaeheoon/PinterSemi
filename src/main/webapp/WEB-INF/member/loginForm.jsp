		...
		<div class="modal-content">
			...
			<div class="modal-body">
			    <form id="loginForm" onsubmit="handleLogin(event)">
			        ...
			        <div>
				        <a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=10cb1c835a0e19d1788ff942199a5de3&redirect_uri=http://localhost/Inbeomstagram/member/kakao/login&response_type=code">
